...
public class ArtifactStatusManager {
    ...
    public static JSONObject changeProxyServiceStatus(String performedBy, MessageContext messageContext,
        ...
        if (proxyService == null) {
            return Utils.createJsonError("Proxy service could not be found",
     ...
     */
    public static JSONObject changeEndpointStatus(String performedBy, org.apache.axis2.context.MessageContext axis2MessageContext,
        ...
        if (ep == null) {
            return Utils.createJsonError("Endpoint does not exist",
                    axis2MessageContext, Constants.NOT_FOUND);
        }
    ...
    public static JSONObject changeMessageProcessorStatus(String performedBy, MessageContext messageContext,
        ...
        if (messageProcessor == null) {
            return Utils.createJsonError("Message processor does not exist",
                    axis2MessageContext, Constants.NOT_FOUND);
        }
